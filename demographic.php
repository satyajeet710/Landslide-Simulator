...
<body>
    ...
    <div class="form-group">
        <label>E-Mail ID (strictly for payment purposes. Enter a fake E-mail ID if you do not wish to be identified.):</label><br>
...
<label>Please describe your knowledge level about life, health, and property insurance against landslide disasters:</label>


<div class="radio">
        <label><input type="radio" name="inslp" value="No idea">No idea</label>
    </div>

<div class="radio">
        <label><input type="radio" name="inslp" value="Little understanding">Little understanding</label>
    </div>

<div class="radio">
        <label><input type="radio" name="inslp" value="Basic understanding">Basic understanding</label>
    </div>
<div class="radio">
        <label><input type="radio" name="inslp" value="Knowledgeable">Knowledgeable</label>
    </div>
<div class="radio">
        <label><input type="radio" name="inslp" value="Highly Knowledgeable" required>Highly Knowledgeable</label>
    </div>

    <label>Have you ever purchased life, health, or property insurances against landslide disasters:</label>


<div class="radio">
        <label><input type="radio" name="inspur" value="No idea">Yes</label>
    </div>

<div class="radio">
        <label><input type="radio" name="inspur" value="Little understanding">No</label>
    </div>
