...
header('Location: http://mridu.acslab.org/index.php');
session_destroy();
   die();
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <br>
<p>Thank you for your participation. Please enter the following ID on Amazon MTurk page: <strong>nurav-<?php echo session_id(); ?></strong>
