...
<meta name="description" content="IIT, India" />
    <meta property="og:image" content="http://mridu.acslab.org/og.JPG" />
<meta property="og:url" content="http://mridu.acslab.org/" />
...
$_SESSION['p_landslide_array'][0] = round($_SESSION['p_landslide_array'][0],2);
    ...
    $sqlprob = "SELECT from_prob, to_prob, image_source FROM message_probability WHERE scenario_id='$scenario_id'";
        ...
        echo $prob_source;
                    ...
                    <script type="text/javascript">
                        function yesnoCheck() {
                            if (document.getElementById('yesCheck').checked) {
                                ...
                                // document.getElementById('ifNoPlan').style.visibility = 'hidden';
                                // document.getElementById('mitigationOptions').style.visibility = 'hidden';
                                document.getElementById('invest').value = 0;
                            }   
                            if (document.getElementById('noCheck').checked) { 
                                // document.getElementById('ifYesPlan').style.visibility = 'hidden';
                        ...
                        function Check1() {
                            if (document.getElementById('Checkbox1').checked) {
                               document.getElementById('checkOne').value = 1173;
                            }
                            else {
                        ...
                        function Check2() {
                            if (document.getElementById('Checkbox2').checked) {
                                document.getElementById('checkTwo').value = 488;
                            }
                            else {
                        ...
                        function Check3() {
                            if (document.getElementById('Checkbox3').checked) {
                                document.getElementById('checkThree').value = 1884; 
                            }
                            else {
                                document.getElementById('checkThree').value = 0;
                            }
                        }
                        function valthisform() {   
                            ...
                            var incomeAvailable='<?php echo $income;?>';
                            //alert (incomeAvailable);    

                            if(sumInsured > incomeAvailable)
                            {
                                alert ("Income available with you is less than the amount required for insurance");
                                return false;
                            }
                             ...
                             if (chkd == true){
                                return true;    
                                        ...
                                        alert ("Please choose an option or fill-in a value");
                                        return false;
                             }
                ...
                <form role="form" id="form2" name="form2" method="post" onsubmit='return valthisform()' action="process.php?id=<?php echo $cryptid; ?>&decision=true&insur_chosen=true">

                 <input type="checkbox" onclick="javascript:yesnoCheck();" name="yesno" id="yesCheck" > Yes, I would like to enroll into some insurance plans for the next month for adapting against landslides.
                 <br>   

                <div class="form-group">
                <div class=container2 id="ifYesPlan" style="visibility:hidden">    
                
                <input type="checkbox" onclick="javascript:Check1();" name="chk1" id="Checkbox1" > Yes, I would like to enroll into a health insurance plan for the next month (1173 EC/month).
                 <br>

                <input type="checkbox" onclick="javascript:Check2();" name="chk2" id="Checkbox2" > Yes, I would like to enroll into a life insurance plan for the next month (488 EC/month).
                 <br>

                <input type="checkbox" onclick="javascript:Check3();" name="chk3" id="Checkbox3" > Yes, I would like to enroll into a property insurance plan for the next month (1884 EC/month).
                 <br>
                </div></div>
                ...
                <input type="hidden" name="checkThree" id="checkThree" value=0 />
                 ...
                 <input type="checkbox" onclick="javascript:yesnoCheck();" name="yesno" id="noCheck"> Yes, I would like to decide the investment for mitigating landslides myself for the next month.
                
                <div class="form-group">
                <div class=container1 id="ifNoPlan" style="visibility:hidden">    
                <label><h3>Your investment for landslide mitigation for month <?php echo $_SESSION['day'];?> (between 0.0 and <?php $abd = floor($_SESSION['daily_income']* 10)/10 ;echo $abd; ?>):</h3></label>
                ...
                <div class="form-group" id="mitigationOptions" style="visibility:hidden">
                    ...
                    <input type="number" class="form-control-retaining_walls" id="invest-retaining_walls" name="invest-retaining_walls" step="0.1"  min=0.0  value="0" max=<?php echo $abd; ?> required><?php echo 'For no investment, please enter 0.0' ;?><br>
                    <label> Drainage Systems & Surface Water Management</label><br>
                    <input type="number" class="form-control-drainage_systems" id="invest-drainage_systems" name="invest-drainage_systems" step="0.1"  min=0.0  value="0" max=<?php echo $abd; ?> required><?php echo 'For no investment, please enter 0.0' ;?><br>
                    <label> Land-Use Planning & Structural Modifications</label><br>
                    <input type="number" class="form-control-land_use_planning" id="invest-land_use_planning" name="invest-land_use_planning" step="0.1"  min=0.0  value="0" max=<?php echo $abd; ?> required><?php echo 'For no investment, please enter 0.0' ;?><br>

                    <h3>Traditional IKS-Based Mitigation Strategies</h3>
                    <label> Soil Classification & Herbal Binding Methods </label><br>
                    <input type="number" class="form-control-soil_classification" id="invest-soil_classification" name="invest-soil_classification" step="0.1"  min=0.0  value="0" max=<?php echo $abd; ?> required><?php echo 'For no investment, please enter 0.0' ;?><br>
                    <label> Tree Planting for Slope Stability </label><br>
                    <input type="number" class="form-control-tree_planting" id="invest-tree_planting" name="invest-tree_planting" step="0.1"  min=0.0  value="0" max=<?php echo $abd; ?> required><?php echo 'For no investment, please enter 0.0' ;?><br>
                    <label> Groundwater & Rainwater Management</label><br>
                    <input type="number" class="form-control-water_management" id="invest-water_management" name="invest-water_management" step="0.1"  min=0.0  value="0" max=<?php echo $abd; ?> required><?php echo 'For no investment, please enter 0.0' ;?><br>
 <h3>Total Investment</h3>
 <input type="number" class="form-control" id="invest" name="invest" step="0.1"  min=0.0 max=<?php echo $abd; ?> >
                    <!-- 
                        <input type="checkbox" name="retaining_walls">
                        <input type="checkbox" name="drainage_systems">
                        <input type="checkbox" name="land_use_planning">

                        <input type="checkbox" name="soil_classification">
                        <input type="checkbox" name="tree_planting">
                        <input type="checkbox" name="water_management">
                    -->
                </div>
      ...
      <div class="modal-footer">
        ...
        <div class="col-md-4"> <div class="well">
                ...
                <table class="table table-hover table-condensed">
                    ...
                    <tr class="info">
                        <th>Income available for investment in this month (M)</th>
...
$sqlntm = "SELECT daily_income-invest-hinsur-linsur-pinsur from game where id='$unqid' AND day >0;";
...
if ($resulttd = mysqli_query($conn, $sqltd)) {
    ...
    $td=$td+$rowtd[0] + 8760 - floor($_SESSION['daily_income']);
    echo round($td,1);
...
function updateTotalInvest() {
    // Get all mitigation input values, treat empty as 0
    var total = 0;
    var ids = [
        'invest-retaining_walls',
        'invest-drainage_systems',
        'invest-land_use_planning',
        'invest-soil_classification',
        'invest-tree_planting',
    ...
    document.getElementById('invest').value = total.toFixed(1);
}
...
window.onload = function() {
    ...
    ids.forEach(function(id) {
        ...
        if (el) {
            el.addEventListener('input', updateTotalInvest);
        }
    });
};
            </script>
