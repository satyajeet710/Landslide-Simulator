...
session_destroy();
    ...
    <i class="fa fa-user"></i> Professor<br>
    ...
    <blockquote>
        <h4 class="kalam">Ph.D Scholar:</h4><br>
        <embed src="Ankush.jpg" height="150" width="150">
        
        <a href="http://www.researchgate.net/profile/Pratik_Chaturvedi"><h3><b>Mr. Ankush</b></h3></a><br>
    <i class="fa fa-user"></i> Ph.D. Student<br>
    <a href="http://www.acslab.org/"><i class="fa fa-plus-square"></i> ACS Lab</a><br>
        <a href="http://www.iitmandi.ac.in"><i class="fa fa-external-link"></i>Indian Institute of Technology, Mandi</a><br>
    <i class="fa fa-map-marker"></i> Himachal Pradesh, India - 175001<br>
    <i class="fa fa-phone"></i> +918091508019<br>
    <i class="fa fa-envelope-o"></i>d24255@students.iitmandi.ac.in<br>
    </blockquote>
