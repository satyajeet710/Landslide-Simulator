...
<meta property="og:description" content="This game is part of a research study conducted by Varun Dutt (Professor at Indian Institute of Technology, Mandi) and Ankush (Ph.D. Student under Prof. Varun Dutt).
...
<div class="jumbotron"><div class="container-fluid">
            ...
            <p class="text-center">
                <p class="text-justify">
                        This game is part of a research study conducted by Ankusn (Ph.d Scholar) under the guidance of Prof. Varun Dutt and Dr. K.V. Uday at the Indian Institute of Technology Mandi, Himachal Pradesh, India - 175005.  
                </p>
                <p class="text-justify">
                       The purpose of the research is to find out how an individual’s decision-making is influenced in the presence of various insurance models against landslides.
                </p>

                <h3><b>Procedures</b></h3>
                <p class="text-justify">
                        Throughout the experiment, you will be asked to make a series of decisions to try and maximize your payoff through your choices. You will be asked to imagine that you are a resident in an Indian Himalayan town, where you need to make monthly investment decisions in order to mitigate landslides. You will be making investment decisions monthly until the program stops on its own.
          </p>
                ...
                <p class="text-justify">
                       If you have any questions about this study, you should feel free to ask them by contacting the Principal Investigators:
                </p>
                <blockquote>
            Prof. Varun Dutt<br>
            Applied Cognitive Science Lab<br>
                    B-08 Bamboo Block, Kamand South Campus<br>
...
//            header('Location: http://pratik.acslab.org/connect.php?id='.$my_cid);
